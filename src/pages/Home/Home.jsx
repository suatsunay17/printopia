    ...
    <div className="home">
      <div className="welcome">
        ...
        <p>
          ...
          precision. From intricate figurines to revolutionary prototypes, each
          piece is a testament to the limitless possibilities of 3D printing
          technology. Browse our gallery to get inspired, or showcase your own
